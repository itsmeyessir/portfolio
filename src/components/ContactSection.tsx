...
export function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <p className="text-neutral-400 text-base sm:text-lg mb-10 max-w-md font-serif leading-relaxed">
        Want to work together or have a question? I&apos;m currently open for
        new opportunities and always excited to connect with fellow builders.
      </p>
